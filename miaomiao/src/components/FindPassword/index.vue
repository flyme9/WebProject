<template>
    <div class="password_body">
        ...
        <div class="password_link">
            <router-link to="/mine/login">点击登录</router-link>
            <router-link to="/mine/register">点击注册</router-link>
        </div>
    </div>
</template>
...
<style scoped>
    ...
    .password_body .password_email button{ position: absolute; right: 15px; top: 10px; height: 30px;border: none;}
